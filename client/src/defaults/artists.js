module.exports = [
	...
	},
	{
		...
		image: 'https://images2.imgbox.com/09/e6/yB7BVjDJ_o.jpg',
		description: `
	...
	{
		name: 'Clintel Steed',
		image: 'https://images2.imgbox.com/04/1b/3gfK3vx8_o.jpg',
		description: `
			...
			<br><br>
			In 2001, Clintel drove to New York City with his easel tied to the top of his car and settled in Harlem. Finding representation with Borghi Fine Art Gallery, exhibitions throughout New York City, the Hamptons, Philadelphia and winning the John Koch award from the Academy of Arts and Letters in 2015, Clintel is an artist who represents the urgency and grit that was synonymous with New York City in the 1970's and 1980's. 
			<br><br>
	...
	},
	{
		...
		image: 'https://images2.imgbox.com/04/1b/3gfK3vx8_o.jpg',
		description: `
			Virginia Baker was born in Texas in 1933. She began to fulfill a lifetime dream of studying art in 1993 when she entered the prestigious Glassell School of Art whom is also affiliated with the Museum of Fine Arts in Houston. She developed a love for watercolors, embracing her emotions and movements to create an abstract image of her inner spirit. 
			<br><br>
			<i>"I am an abstract artist that expresses emotion, movement and action. I am led by watercolor magic as the paint and water begin to mix and flow across the paper. I paint - -mostly- -”Wet into Wet”. My work has been described as vibrant, uplifting and joyful. That is my goal each time I approach the paper. The medieval symbol that follows my signature on every painting represents 'Mind, Body, Soul'"</i>
			<br><br>
			-Virginia Baker
			<br><br>
