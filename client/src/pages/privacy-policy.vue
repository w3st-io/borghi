<template>
	<BContainer fluid class="m-0 p-0 bg-light">
		<BContainer class="py-5 text-dark">
			...
			<li>
			<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to JJ SHOP LLC, 255 herbert ave. 07624, Closter, NJ.</p>
			</li>
			<li>
			...
			<li>
			<p><strong>Website</strong> refers to jjinthemaking, accessible from <a href="www.jjinthemaking.com" rel="external nofollow noopener" target="_blank">www.jjinthemaking.com</a></p>
			</li>
			<li>
			...
			<ul>
			<li>
			<p>By email: jonnyjoeys@gmail.com</p>
			</li>
			<li>
			<p>By visiting this page on our website: <a href="https://www.jjinthemaking.com/contact" rel="external nofollow noopener" target="_blank">https://www.jjinthemaking.com/contact</a></p>
			</li>
			</ul>
		</BContainer>
	</BContainer>
